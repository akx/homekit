  ...
  [
    ...
    m('div.columns', [
      ...
      forecast.currently.precipProbability ?
          m('div.precip', `${forecast.currently.precipProbability}% chance of rain`)
          : null
      ),
      m('div.wind', [
        ...
        m('div',
          ...
          m('div.arrow', {
            style: `transform:rotate(${forecast.currently.windBearing - 90}deg)`,
          }, '\u27a4')
        ),
      ]),
    ]),
